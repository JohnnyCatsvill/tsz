...
export class nodexuita1647794027882 implements MigrationInterface {
    name = 'nodexuita1647794027882'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "issue" ADD CONSTRAINT "FK_081f60a280fe0ffdea9851aa769" FOREIGN KEY ("flatId") REFERENCES "flat"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
